...
const shield3= new Items(21, "Fairy Elf", "Frost Shield", 350)
const shield4= new Items(22, "Magic Gladiator", "Salamander Shield", 350)
const shield5= new Items(23, "Dark Lord", "Cross Shield", 350)
const shield6= new Items(24, "Summoner", "Book of Lagle", 350)

const webShop = []
webShop.push(wing1, wing2, wing3, wing4, wing5, wing6, set1, set2, set3, set4, set5, set6, ring1, ring2, ring3, pendant1, pendant2, pendant3, arma1, arma2, arma3, arma4, arma5, arma6, shield1, shield2, shield3, shield4, shield5, shield6)
